export default {
  ...
  plugins: ['~/plugins/ws.client.js', "~/plugins/util.js"],
  ...
  publicRuntimeConfig: {
    ...
    apiUrl: process.env.VUE_APP_API_URL || 'http://localhost:8089',
    socketUrl: process.env.VUE_APP_SOCKET_URL || 'ws://localhost:8089',
